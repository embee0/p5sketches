...
function setup() {
  ...
  // URL-Parameter bsp auslesen  (Nummer des Beispiels, das geladen werden soll)
  // Aufruf zB: https://embee0.github.io/p5sketches/sketches/neuralnetwork03urlparams/?bsp=3
  let params = getURLParams();
  let bsp = defaultBsp;
  if (params.bsp !== undefined && !isNaN(params.bsp)) {
    bsp = Number(params.bsp);
  }
  ...
  exampleSelector.selected("Beispiel " + bsp);
